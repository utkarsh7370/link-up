                    ...
                    <div className="register__rightdatacontainer">
                        <div className="register__appwrapper">
                            <div className='register__heading'>
                                <h1 className="register__titles">
                                    <Link className='register__link' to='/signup'>Sign Up</Link>
                                </h1>

                                <h1 className="register__titles">
                                    <Link className='register__link' to='/Login'>Log In</Link></h1>

                            </div>
                            <form className='register__formwrapper mt-3' onSubmit={handleSubmit}>
                                ...
                                <div c4lassName="register__contact">
